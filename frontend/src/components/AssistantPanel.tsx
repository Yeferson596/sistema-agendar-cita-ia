        ...
        <div className="space-y-4">
          ...
          <div className="rounded-[28px] border border-border/60 bg-white p-5 shadow-sm">
            ...
            <p className="text-sm text-muted-foreground leading-6">
              El asistente usa información de los documentos internos y guías externas para generar una respuesta contextualizada. Si no está disponible la clave de Roq, se mostrará un resumen local.
            </p>
            {provider ? (
              <p className="mt-3 text-xs text-muted-foreground">Proveedor de IA: {provider.toUpperCase()}</p>
            ) : null}
          </div>
        </div>
