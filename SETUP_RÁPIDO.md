...
.\.venv\Scripts\python.exe -m uvicorn app.main:app --reload --host 0.0.0.0 --port 8000 --app-dir .
```
...
```bash
cd backend
.\.venv\Scripts\python.exe -m uvicorn app.main:app --reload --host localhost --port 8000 --app-dir .
```
